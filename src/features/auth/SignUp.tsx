    ...
    <IonPage>
      ...
      <IonContent fullscreen className="auth">
        <div className="auth__body">
          {f.phase === 'collect' ? (
            <>
              <h1 className="auth__title since-h1">Create your account</h1>
              <p className="auth__subtext since-dek">Start tracking how long it's been.</p>
              <AuthField
                label="Email"
                type="email"
                inputMode="email"
            ...
            <>
              <h1 className="auth__title since-h1">Confirm your email</h1>
              <p className="auth__subtext since-dek">We sent a code to {f.email}.</p>
              <AuthField
